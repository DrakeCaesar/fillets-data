    ...
    local function prog_init_krab1()
        ...
        return function()
            if room:isTalking() then
                switch(math.modf(game_getCycles(), 4)){
                    [0] = function()
                        krab1.krabfaze = 7
                    end,
                    [1] = function()
    ...
    local function prog_init_balalajka()
        ...
        return function()
            ...
            switch(balalajka.cinnost){
                [0] = function()
                    local cycle = math.modf(game_getCycles(), 18)
                    switch(cycle){
                        [0] = function()
        ...
        return function()
            ...
            if isWater(sas1.X + 1, sas1.Y - 1) or modelEquals(room, sas1.X + 1, sas1.Y - 1) then
                if sas1.sasfaze >= 0 then
                    ...
                    if math.modf(game_getCycles(), 3) == 0 and random(100) < 50 then
                        sas1.kvet = random(2) * 2 + 1
                    end
                    if math.modf(game_getCycles(), 4) == 0 and random(100) < 30 then
                        sas1.noha = random(2)
                    end
