...
dialogStr("До сих пор справлялись - и здесь не пропадём.")

dialogId("init-3-2", "font_small", "The topic of this branch is: ”UFO-Exit”, which means we will get out of here.")
dialogStr("Название ответвления - „Выход из НЛО“. Это означает, что мы выйдем отсюда.")
...
dialogStr("И как мы это сделаем? Мы способны только двигать предметы.")

dialogId("rand-0-2", "font_small", "So let’s move the lever down there.")
dialogStr("Давай сдвинем тот рычаг вниз.")
...
dialogStr("В конце концов, он должен быть связан с электромагнитным полем в правом верхнем углу.")
...
dialogStr("Не думаю. В задании сказано разобраться, как работает межзвёздный двигатель.")

dialogId("rand-1-2", "font_small", "What if the magnets are part of the interstellar propulsion?")
dialogStr("А что если магниты являются частью межзвёздного двигателя?")

dialogId("rand-1-3", "font_big", "Then we should figure that out. But in my opinion they are only here to be in our way.")
dialogStr("Тогда мы должны разобраться. Но, я думаю, они здесь только для того, чтобы мешаться нам на пути.")
...
dialogStr("Ну вон там, внизу, маленькая жестяная банка.")

dialogId("rand-2-3-0", "font_big", "Perhaps it is still full.")
dialogStr("Может быть, она всё ещё полная.")
...
dialogStr("Почему магниты находятся на постоянном расстоянии и не притягиваются друг к другу?")
...
dialogStr("Ещё один топливный стержень.")
...
dialogStr("Тогда бы мы до сих пор находились там.")

dialogId("rand-5-3-1", "font_small", "Perhaps it was not a reactor.")
dialogStr("Может быть, это был не реактор.")
...
dialogStr("Неопознанный инопланетный артефакт. Ты о какой именно из них?")

dialogId("rand-6-2", "font_small", "The angular one which is in our way, the one spanning half the level.")
dialogStr("В углу, где выход. Ну то, что занимает половину уровня.")

dialogId("rand-6-3", "font_big", "As I said, it is an unidentified alien artefact.")
dialogStr("Как я уже сказал, это неопознанный инопланетный артефакт.")
...
dialogStr("Отсутствие плохих новостей - это уже хорошая новость.")

dialogId("shoot-5", "font_big", "Why aren’t the aliens so peaceful that they don’t need weapons?")
dialogStr("Почему НЛО не могут быть настолько миролюбивыми, чтобы им не тробовалось оружие?")

dialogId("shoot-6", "font_small", "I wonder the same thing about humans.")
dialogStr("Я задаюсь тем же вопросом по отношению к людям.")
