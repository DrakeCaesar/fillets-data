...
local function prog_init()
    ...
    local function prog_init_krab1()
        ...
        return function()
            ...
            elseif krab1.afaze > 5 or math.modf(game_getCycles(), 3) == 0 and random(100) < 40 then
    ...
    local function prog_init_krab2()
        ...
        return function()
            ...
            elseif krab2.afaze > 5 or math.modf(game_getCycles(), 3) == 0 and random(100) < 40 then
    ...
    local function prog_init_krab3()
        ...
        return function()
            ...
            elseif krab3.afaze > 5 or math.modf(game_getCycles(), 3) == 0 and random(100) < 40 then
    ...
    local function prog_init_krab4()
        ...
        return function()
            ...
            elseif krab4.afaze > 5 or math.modf(game_getCycles(), 3) == 0 and random(100) < 40 then
        ...
        return function()
            ...
            if klavir.vyruseni > 0 then
                ...
                if klavir.otocka > 0 and klavir.mrknuti > 0 then
                    ...
                    klavir.ruce = math.modf(klavir.ruce + random(3) + 1, 4)
        ...
        return function()
            ...
            if pomb1 or not pomb2 then
                if odd(game_getCycles()) then
                    sepie.nohy = math.modf(sepie.nohy + 2 + random(2) * 2, 3)
                end
                ...
                if sepie.dir == dir_left or sepie.dir == dir_down then
                    sepie.nohy = math.modf(sepie.nohy + 1, 2)
                else
                    sepie.nohy = 0
                end
                if sepie.mrk > 0 then
    ...
    local function prog_init_rejnok()
        ...
        return function()
            if math.modf(game_getCycles(), 2) == 0 or rejnok.nespi > 20 then
    ...
    local function prog_init_sasanka()
        ...
        return function()
            if isWater(sasanka.X, sasanka.Y - 1) then
                local cycle = math.modf(game_getCycles(), 8)
