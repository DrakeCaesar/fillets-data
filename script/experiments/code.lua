...
local function prog_init()
    ...
    local function prog_init_room()
        ...
        return function()
            if no_dialog() and isReady(small) and isReady(big) then
                ...
                if room.vic < 2 and math.modf(game_getCycles(), 8) == 1 then
                    pom2 = 0
            ...
            if math.modf(game_getCycles(), 800) == 777 then
                switch(random(10)){
                    [1] = function()
                        room.ruk = 0
                    end,
    ...
    local function prog_init_klicka()
        return function()
            klicka.afaze = math.modf(game_getCycles(), 2)
            klicka:updateAnim()
        end
    end
    ...
    local function prog_init_horni1()
        ...
        return function()
            ...
            if math.modf(game_getCycles(), 3) == 0 and random(100) < 40 then
                horni1.oci = random(5)
            end
            ...
            for key, tube in pairs(tubes) do
                if tube.glob > 0 then
                    ...
                    if odd(game_getCycles() + key) then
                        if random(2) > 0 then
                            tube.afaze = math.modf(tube.afaze + 1, 3)
                        else
                            tube.afaze = math.modf(tube.afaze + 2, 3)
                        end
                    end
                else
                    tube.glob = tube.glob + 1
    ...
    local function prog_init_qldik1()
        ...
        return function()
            ...
            if math.modf(game_getCycles(), 3) == 0 then
    ...
    local function prog_init_lahvac()
        ...
        return function()
            switch(lahvac.rozbit){
                [0] = function()
                    if math.modf(game_getCycles(), 4) == 0 then
                        switch(random(4)){
                            [0] = function()
                                lahvac.vnitrek = math.modf(lahvac.vnitrek + 1, 4)
                            end,
                            [1] = function()
                                lahvac.vnitrek = math.modf(lahvac.vnitrek + 3, 4)
                            end,
                        }
                    end
                    switch(lahvac.stav){
                        [0] = function()
                            ...
                            elseif random(100) < 7 then
                                ...
                                lahvac.afaze = 7 + lahvac.stav * 4 + math.modf(lahvac.vnitrek, 2)
                            else
                        ...
                        [3] = function()
                            if random(100) < 7 then
                                lahvac.stav = 2
                                lahvac.afaze = 15 + math.modf(lahvac.vnitrek, 2)
                            elseif random(100) < 7 then
                                lahvac.stav = 4
                                lahvac.afaze = 22 + math.modf(lahvac.vnitrek, 2)
                            elseif math.modf(lahvac.vnitrek, 2) == 1 and random(100) < 10 then
                                lahvac.afaze = 19
                            else
                                lahvac.afaze = 20 + math.modf(lahvac.vnitrek, 2)
                            end
                        end,
                        [4] = function()
                            if random(100) < 7 then
                        ...
                        default = function()
                            if 1 <= lahvac.stav and lahvac.stav <= 2 then
                                ...
                                elseif random(100) < 7 and lahvac.stav == 2 then
                                    ...
                                    lahvac.afaze = 9 + 4 * lahvac.stav + math.modf(lahvac.vnitrek, 2)
                                    if random(100) < 5 then
                ...
                [10] = function()
                    if lahvac.stav == 0 then
                        ...
                        if odd(game_getCycles()) then
                            if random(2) == 0 then
                                lahvac.afaze = math.modf(lahvac.afaze - 30, 3) + 31
                            else
                                lahvac.afaze = math.modf(lahvac.afaze - 29, 3) + 31
                            end
                        end
                        lahvac.stav = lahvac.stav - 1
                    end
                ...
                switch(ruka.cinnost){
                    [0] = function()
                        if random(100) < 2 then
                            ...
                            if ruka.smer == 0 then
                                ruka.faze = math.modf(ruka.faze + 1, 7)
                            else
                                ruka.faze = math.modf(ruka.faze + 6, 7)
                            end
